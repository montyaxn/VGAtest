//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=27 LPM_WIDTHB=10 LPM_WIDTHP=37 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
...
module  mult_il01
	...
	wire  [27:0]   wire_sft10a_in;
	wire  [27:0]   wire_sft10a_out;
	wire  [27:0]   wire_sft11a_in;
	wire  [27:0]   wire_sft11a_out;
	...
	wire  [27:0]   wire_sft8a_in;
	wire  [27:0]   wire_sft8a_out;
	wire  [27:0]   wire_sft9a_in;
	wire  [27:0]   wire_sft9a_out;
	wire  [26:0]  dataa_node;
	wire  [9:0]  datab_node;
	wire  [36:0]  final_result_node;
	wire  w333w;
	wire  [37:0]  w590w;
	wire  [269:0]  w_decoder_node9w;
	...
	assign
		wire_sft8a_in = {w333w, {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[138], {w_sum_node10w[137], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101], {w_sum_node10w[100], {w_sum_node10w[99], {w_sum_node10w[98], {w_sum_node10w[97], {w_sum_node10w[96], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[93], {w_sum_node10w[92], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88:87]}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft9a_0
	( 
	...
	assign
		wire_sft9a_in = {w333w, {w333w, {w333w, {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {w_sum_node10w[79], {w_sum_node10w[78], {w_sum_node10w[77], {w_sum_node10w[76], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[73], {w_sum_node10w[72], {w_sum_node10w[71], {w_sum_node10w[70], {w_sum_node10w[69], {w_sum_node10w[68], {w_sum_node10w[67], {w_sum_node10w[66], {w_sum_node10w[65], {w_sum_node10w[64], {w_sum_node10w[63], {w_sum_node10w[62], {w_sum_node10w[61:60]}}}}}}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {dataa[26:0]},
		datab_node = {datab[9:0]},
		final_result_node = {w590w[36:0]},
		result = {final_result_node[36:0]},
		w333w = 1'b0,
		w590w = {wire_sft6a_out[35:34], wire_sft6a_out[33:32], wire_sft6a_out[31:30], wire_sft6a_out[29:28], wire_sft6a_out[27:26], wire_sft6a_out[25:24], wire_sft6a_out[23:22], wire_sft6a_out[21:20], wire_sft6a_out[19:18], wire_sft6a_out[17:16], wire_sft6a_out[15:14], wire_sft6a_out[13:12], wire_sft6a_out[11:10], wire_sft6a_out[9:8], wire_sft6a_out[7:6], wire_sft6a_out[5:4], wire_sft6a_out[3:2], wire_sft6a_out[1:0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[26:0]} & {27{w_le_datab_node8w[9]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[8]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[7]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[6]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[5]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[4]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[3]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[2]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[1]}}), ({dataa_node[26:0]} & {27{w_le_datab_node8w[0]}})},
