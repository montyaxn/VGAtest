//lpm_mult CBX_DECLARE_ALL_CONNECTED_PORTS="OFF" DEDICATED_MULTIPLIER_CIRCUITRY="NO" DEVICE_FAMILY="Cyclone V" DSP_BLOCK_BALANCING="Auto" INPUT_A_IS_CONSTANT="NO" INPUT_B_IS_CONSTANT="NO" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTHA=14 LPM_WIDTHB=18 LPM_WIDTHP=32 LPM_WIDTHS=1 MAXIMIZE_SPEED=5 dataa datab result CARRY_CHAIN="MANUAL" CARRY_CHAIN_LENGTH=48
//VERSION_BEGIN 21.1 cbx_cycloneii 2022:06:23:22:02:32:SJ cbx_lpm_add_sub 2022:06:23:22:02:32:SJ cbx_lpm_mult 2022:06:23:22:02:32:SJ cbx_mgl 2022:06:23:22:26:17:SJ cbx_nadder 2022:06:23:22:02:32:SJ cbx_padd 2022:06:23:22:02:32:SJ cbx_stratix 2022:06:23:22:02:32:SJ cbx_stratixii 2022:06:23:22:02:32:SJ cbx_util_mgl 2022:06:23:22:02:32:SJ  VERSION_END
...
module  mult_gl01
	...
	wire	[14:0]	wire_add12_result;
	wire	[30:0]	wire_add2_result;
	wire	[22:0]	wire_add7_result;
	...
	wire  [22:0]   wire_sft10a_in;
	wire  [22:0]   wire_sft10a_out;
	wire  [22:0]   wire_sft11a_in;
	wire  [22:0]   wire_sft11a_out;
	wire  [14:0]   wire_sft13a_in;
	wire  [14:0]   wire_sft13a_out;
	wire  [14:0]   wire_sft14a_in;
	wire  [14:0]   wire_sft14a_out;
	wire  [14:0]   wire_sft15a_in;
	wire  [14:0]   wire_sft15a_out;
	wire  [14:0]   wire_sft16a_in;
	wire  [14:0]   wire_sft16a_out;
	wire  [30:0]   wire_sft3a_in;
	wire  [30:0]   wire_sft3a_out;
	wire  [30:0]   wire_sft4a_in;
	wire  [30:0]   wire_sft4a_out;
	wire  [30:0]   wire_sft5a_in;
	wire  [30:0]   wire_sft5a_out;
	wire  [30:0]   wire_sft6a_in;
	wire  [30:0]   wire_sft6a_out;
	wire  [22:0]   wire_sft8a_in;
	wire  [22:0]   wire_sft8a_out;
	wire  [22:0]   wire_sft9a_in;
	wire  [22:0]   wire_sft9a_out;
	...
	assign
		wire_sft10a_in = {w375w, {w375w, {w375w, {w375w, {w_sum_node10w[78], {w_sum_node10w[131], {w_sum_node10w[130], {w_sum_node10w[111], {w_sum_node10w[110], {w_sum_node10w[91], {w_sum_node10w[90], {w_sum_node10w[89], {w_sum_node10w[88], {w_sum_node10w[87], {w_sum_node10w[86], {w_sum_node10w[85], {w_sum_node10w[84], {w_sum_node10w[83], {w_sum_node10w[82], {w_sum_node10w[81], {w_sum_node10w[80], {2{w375w}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft11a_0
	( 
	...
	assign
		wire_sft13a_in = {w375w, {w_sum_node10w[59], {w_sum_node10w[58], {w_sum_node10w[129], {w_sum_node10w[128], {w_sum_node10w[109], {w_sum_node10w[108], {w_sum_node10w[107], {w_sum_node10w[106], {w_sum_node10w[105], {w_sum_node10w[104], {w_sum_node10w[103], {w_sum_node10w[102], {w_sum_node10w[101:100]}}}}}}}}}}}}}};
	soft   sft14a_0
	( 
	...
	assign
		wire_sft14a_in = {w375w, {w375w, {w375w, {w_sum_node10w[57], {w_sum_node10w[56], {w_sum_node10w[37], {w_sum_node10w[36], {w_sum_node10w[35], {w_sum_node10w[34], {w_sum_node10w[33], {w_sum_node10w[32], {w_sum_node10w[31], {w_sum_node10w[30], {w_sum_node10w[29:28]}}}}}}}}}}}}}};
	soft   sft15a_0
	( 
	...
	assign
		wire_sft15a_in = {w375w, {w375w, {w375w, {w375w, {w375w, {w_sum_node10w[127], {w_sum_node10w[126], {w_sum_node10w[125], {w_sum_node10w[124], {w_sum_node10w[123], {w_sum_node10w[122], {w_sum_node10w[121], {w_sum_node10w[120], {2{w375w}}}}}}}}}}}}}}};
	soft   sft16a_0
	( 
	...
	assign
		wire_sft4a_in = {w375w, {w375w, {w375w, {w_sum_node10w[137], {w_sum_node10w[136], {w_sum_node10w[117], {w_sum_node10w[116], {w_sum_node10w[97], {wire_sft11a_out[18], {wire_sft11a_out[17], {wire_sft11a_out[16], {wire_sft11a_out[15], {wire_sft11a_out[14], {wire_sft11a_out[13], {wire_sft11a_out[12], {wire_sft11a_out[11], {wire_sft11a_out[10], {wire_sft11a_out[9], {wire_sft11a_out[8], {wire_sft11a_out[7], {wire_sft11a_out[6], {wire_sft11a_out[5], {wire_sft11a_out[4], {w_sum_node10w[27], {w_sum_node10w[26], {w_sum_node10w[25], {w_sum_node10w[24], {w_sum_node10w[23], {w_sum_node10w[22], {w_sum_node10w[21:20]}}}}}}}}}}}}}}}}}}}}}}}}}}}}}};
	soft   sft5a_0
	( 
	...
	assign
		wire_sft9a_in = {w375w, {w375w, {w375w, {w_sum_node10w[115], {w_sum_node10w[114], {w_sum_node10w[95], {w_sum_node10w[94], {w_sum_node10w[75], {w_sum_node10w[74], {w_sum_node10w[55], {w_sum_node10w[54], {w_sum_node10w[53], {w_sum_node10w[52], {w_sum_node10w[51], {w_sum_node10w[50], {w_sum_node10w[49], {w_sum_node10w[48], {w_sum_node10w[47], {w_sum_node10w[46], {w_sum_node10w[45], {w_sum_node10w[44], {w_sum_node10w[43:42]}}}}}}}}}}}}}}}}}}}}}};
	assign
		dataa_node = {datab[17:0]},
		datab_node = {dataa[13:0]},
		final_result_node = {w651w[31:0]},
		result = {final_result_node[31:0]},
		w375w = 1'b0,
		w651w = {wire_sft6a_out[30:29], wire_sft6a_out[28:27], wire_sft6a_out[26:25], wire_sft6a_out[24:23], wire_sft6a_out[22:21], wire_sft6a_out[20:19], wire_sft6a_out[18:17], wire_sft6a_out[16:15], wire_sft6a_out[14:13], wire_sft6a_out[12:11], wire_sft6a_out[10:9], wire_sft6a_out[8:7], wire_sft6a_out[6:5], wire_sft6a_out[4:3], wire_sft6a_out[2:1], wire_sft6a_out[0], w_sum_node10w[1], w_sum_node10w[0]},
		w_decoder_node9w = {({dataa_node[17:0]} & {18{w_le_datab_node8w[13]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[12]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[11]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[10]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[9]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[8]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[7]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[6]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[5]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[4]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[3]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[2]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[1]}}), ({dataa_node[17:0]} & {18{w_le_datab_node8w[0]}})},
		w_le_datab_node8w = {datab_node[13:0]},
		w_sum_node10w = {wire_sum_adder1aa_6result[18:0], w_decoder_node9w[216], wire_sum_adder1aa_5result[18:0], w_decoder_node9w[180], wire_sum_adder1aa_4result[18:0], w_decoder_node9w[144], wire_sum_adder1aa_3result[18:0], w_decoder_node9w[108], wire_sum_adder1aa_2result[18:0], w_decoder_node9w[72], wire_sum_adder1aa_1result[18:0], w_decoder_node9w[36], wire_sum_adder1aa_0result[18:0], w_decoder_node9w[0]};
endmodule //mult_gl01
//VALID FILE
